...
<style scoped>
/* Estilo específico para este simulador */
.qosmos-wrapper {
  min-height: 100vh;
}
...
.progress-fill.zero { background: linear-gradient(to right, #38bdf8, #8b5cf6); }
